//I was unable to set-up JAUS++ in my laptop but tried to understand the JAUS coding as much as I could
         ...
         if(JAUS::Time::GetUtcTimeMs() - displayStatusTimeMs > 500)
         {
                 ...
                 subsystem++)
             {
                     ...
                     t++)
                 {
                     ...
                     {
                         transportService->AddConnection((*t), JAUS::Address(90, 1, 1));
